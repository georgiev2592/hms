...
class Form(object):
    ...
    def render(self):
        ...
        for i in self.inputs:
            ...
            if i.is_hidden():
                out += '    <tr style="display: none;"><th></th><td style="width: 100%%;">%s</td></tr>\n' % (html)
            else:
                out += '    <tr><th style="width: 30%%;"><label for="%s">%s</label></th><td style="width: 70%%;">%s</td></tr>\n' % (i.id, net.websafe(i.description), html)
        out += "</table>"
        return out
...
class Input(object):
    ...
    def render(self):
        ...
        return '<div class="form-group"><input %s/></div>' % attrs
...
class Textarea(Input):
    ...
    def render(self):
        ...
        return '<div class="form-group"><textarea %s>%s</textarea></div>' % (attrs, value)
...
class Dropdown(Input):
    ...
    def render(self):
        ...
        x = '<div class="form-group"><select %s>\n' % attrs
